...
dir.create('./output_network_analyses')
grn = performAllNetworkAnalyses(grn, ontology = c("GO_BP"), outputFolder = "output_network_analyses", forceRerun = TRUE)
grn = deleteIntermediateData(grn)
saveRDS(grn, 'grn_REAL_final.rds')
